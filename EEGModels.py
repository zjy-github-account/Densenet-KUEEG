...
def EEGNet(nb_classes, Chans = 20, Samples = 1000,
    ...
    block2       = SeparableConv2D(F2, (1, 16),data_format='channels_first',
                                   use_bias = False, padding = 'same')(block1)
    block2       = BatchNormalization(axis = 1)(block2)
    block2       = Activation('elu')(block2)
    block2       = AveragePooling2D((1, 16),data_format='channels_first')(block2)
...
def DeepConvNet(nb_classes, Chans = 20, Samples = 1000,
                dropoutRate = 0.5):
    ...
    # start the model
    input_main   = Input((1, Chans, Samples))
    block1       = Conv2D(25, (1, 10),data_format='channels_first',
                          input_shape=(1, Chans, Samples),
    ...
    block2       = Conv2D(50, (1, 10),data_format='channels_first',
                          kernel_constraint = max_norm(2., axis=(0,1,2)))(block1)
    ...
    block3       = Conv2D(100, (1, 10),data_format='channels_first',
    ...
    block4       = Conv2D(200, (1, 10),data_format='channels_first',
...
def ShallowConvNet(nb_classes, Chans = 20, Samples = 1000, dropoutRate = 0.5):
    ...
    # start the model
    input_main   = Input((1, Chans, Samples))
    block1       = Conv2D(40, (1, 25),data_format='channels_first',
                          input_shape=(1, Chans, Samples),
                          kernel_constraint = max_norm(2., axis=(0,1,2)))(input_main)
    block1       = Conv2D(40, (Chans, 1),data_format='channels_first', use_bias=False,
                          kernel_constraint = max_norm(2., axis=(0,1,2)))(block1)
    block1       = BatchNormalization(axis=1, epsilon=1e-05, momentum=0.1)(block1)
